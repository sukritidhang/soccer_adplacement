# -*- coding: utf-8 -*-
"""Copy of ad_placement-LAB-occlud-transp-psc-video.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ld6Dmd8bHMtZ3pTN9GPr7yuzF7U0lhis

considering occlusion
person sports ball-  output saved as imagename-ps.png
all object - output saved as  imagename-allob.png
"""
...
for frame_file in tqdm(frame_files, desc="Processing frames"):
    ...
    mask_path = os.path.join(mask_dir, f"frame_{frame_id_str}_mask.jpg")
